...
describe('With VCR', () => {
  ...
  const token = {
    access_token:
      '34d7eba1886464d76c01478fd42ff490b98ade03907e727eb6370a0c56fdb16d',
    created_at: '2020-01-15T20:13:14',
    expires_in: 7200,
    refresh_token:
      '7cfab321c5caf556790c41456078e5a7e2de7e84cd874ce22a25dba054fa2d76',
    scope: '',
    token_type: 'bearer'
  }
  ...
  test('create integration performed action', async () => {
    const ipa: any =
      await clockk.createIntegrationPerformedAction(
